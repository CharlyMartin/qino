...
| [02-collections.md](./specs/02-collections.md)                 | stable      | `defineCollection`, `getMany`, `getOne`, slug rules              |
| [03-items.md](./specs/03-items.md)                             | v1-proposed | `defineItem` — single-file content                               |
| [04-trees.md](./specs/04-trees.md)                             | v1-proposed | `defineTree` — hierarchical/ordered content                      |
