...
`examples/next-js/qino/trees/docs.ts:12` exports `docsTreeV1`; nothing imports it. Keep only if it's a deliberate demo of multi-version trees — then reference it somewhere or comment why. **Feasibility: trivial.**
...
- `examples/next-js/src/app/layout.tsx:16-17` — still `title: "Create Next App"`.
